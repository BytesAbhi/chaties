...
use App\Filament\Distt\Resources\BankdetailsResource\Pages;
use App\Filament\Distt\Resources\BankdetailsResource\RelationManagers;
...
class BankdetailsResource extends Resource
{
    ...
    public static function getEloquentQuery(): Builder
    {
        return parent::getEloquentQuery()
            ->where('role', 'District Coordinator')
